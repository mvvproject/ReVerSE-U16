Atari-800 emulation for ReVerSE-U16 Rev.C board (https://github.com/mvvproject/ReVerSE-U16/tree/master/u16_atari800)
Ported from http://www.scrameta.net/ by AlSp (extmail _at_ alsp.net)

Please use:
	- release/u16_atari800_ntsc.jic - for FPGA programming (NTSC mode emulation)
	- release/u16_atari800_pal.jic  - for FPGA programming (PAL mode emulation)
	- vnc2/build/release/firmware.rom - for vnc2 programming
	- sd/* - sd card content
