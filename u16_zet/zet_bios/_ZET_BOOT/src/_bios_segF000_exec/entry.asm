...
ebda_post:    mov     ax, EBDA_SEG                                         ;; EBDA Segment
                        ...
                        ;;call copy_vga_bios        ;; ========== LOADED BY BOOT LOADER
...
;;////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ROMBIOS__START			equ     0x0000                   ;; 
ROMBIOSLENGTH           equ     0x7F80                   ;;  
;;
;;--------------------------------------------------------------------------
shadowcopy:				mov     ax, ROMBIOSSEGMENT                  ; Load with the segment of the extra bios rom area
                       ...
                       ;--------------------- Load MSB  FLASH address ---------------------------
                        ...
                        mov     ax, 0x0000				;; Load MSB  FLASH address                 0x20 0000 - Full adress
                        out     dx, ax                  ;; Save MSB  FLASH address 
                       ;---------------------------------------------------------------------------------------
                        mov     bx, 0x8000				;; Bios starts at offset address in FLASH 
