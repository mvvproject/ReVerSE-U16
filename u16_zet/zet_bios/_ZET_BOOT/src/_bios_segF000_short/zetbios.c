...
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
#define BIOS_COPYRIGHT_STRING   "2015 04 15 U16_ZET STEP1 \n"
void __cdecl print_bios_banner(void)
{
   ...
   */
	...
	tested_segment = 0xF000;
	bios_printf(BIOS_PRINTF_COMPORT, "READY \n");
    addr = 0x0000;
	val  = 0x33;
	write_byte( tested_segment, addr , val);
    addr = 0x0001;
	...
	//=======================================
	addr = 0x0000;
    val = read_byte( tested_segment, addr);
	bios_printf(BIOS_PRINTF_COMPORT, "TEST MEM : addr - %x, data- %x \n", addr, val);
	addr = 0x0001;
    val = read_byte( tested_segment, addr);
	bios_printf(BIOS_PRINTF_COMPORT, "TEST MEM : addr - %x, data- %x \n ", addr, val);
	addr = 0x0002;
   ...
   /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    while(1)
    {
		...
		/*
		case 0:
			bios_printf(BIOS_PRINTF_COMPORT,  "COMMAND - TESTMEM BYTE \n");
			bios_printf(BIOS_PRINTF_COMPORT,  "Enter:  SEG, START/STOP ADDRR \n");
			...
			//=======2 Read Load START ADDRESS =========
			val = Read_UART();
			start = Read_UART();
			start =  (start<<8) + val;
			bios_printf(BIOS_PRINTF_COMPORT,  "START ADDR : %x \n", start);

			//=======3 Read Load STOP ADDRESS =========
			val = Read_UART();
			end = Read_UART();
			end =  (end<<8) + val;
			bios_printf(BIOS_PRINTF_COMPORT,  "STOP ADDR : %x \n", end);
		...
		*/
        case 1:          //FIXME should beep
			...
			bios_printf(BIOS_PRINTF_COMPORT,  "Enter  SEG, ADDRR \n");
			//=======1 Read SEGMENT===============
			val = Read_UART();
			segment = Read_UART();
			segment =  (segment<<8) + val;
			...
			addr = Read_UART();
			addr =  (addr<<8) + val;
			bios_printf(BIOS_PRINTF_COMPORT,  "ADDR : %x \n", start);
			//===============================================================

			val = read_byte( segment, addr);
			bios_printf(BIOS_PRINTF_COMPORT,  "VALUE : %x \n", val);
            break;
        
		case 2:
			bios_printf(BIOS_PRINTF_COMPORT,  "COMMAND - WR BYTE \n");
			bios_printf(BIOS_PRINTF_COMPORT,  "Enter  SEG, ADDRR \n");
			//=======1 Read SEGMENT===============
			val = Read_UART();
			segment = Read_UART();
			...
			//=======3 Read Load DATA 
			val = Read_UART();
			bios_printf(BIOS_PRINTF_COMPORT,  "DATA : %x \n", val);
			//===============================================================
			write_byte( segment, addr , val);	
        break;

        case 3:
			bios_printf(BIOS_PRINTF_COMPORT,  "COMMAND - RD WORD \n");
			bios_printf(BIOS_PRINTF_COMPORT,  "Enter  SEG, ADDRR \n");
			//=======1 Read SEGMENT===============
			val = Read_UART();
			segment = Read_UART();
			...
			val_w = read_word( segment, addr);
			bios_printf(BIOS_PRINTF_COMPORT,  "VALUE : %x \n", val_w);
            break;

        case 4:
			bios_printf(BIOS_PRINTF_COMPORT,  "COMMAND - WR WORD \n");
			bios_printf(BIOS_PRINTF_COMPORT,  "Enter  SEG, ADDRR \n");
			//=======1 Read SEGMENT===============
			val = Read_UART();
			segment = Read_UART();
			...
			val_w = Read_UART();
			val_w =  (val_w<<8) + val;
			bios_printf(BIOS_PRINTF_COMPORT,  "DATA_W : %x \n", val_w);
			//===============================================================
			write_word( segment, addr , val_w);
            break;

		case 5:
			bios_printf(BIOS_PRINTF_COMPORT,  "COMMAND - RD PORT WORD \n");
			bios_printf(BIOS_PRINTF_COMPORT,  "Enter   - ADDRR        \n");
			//=======1 Read Load ADDRESS =========
			val = Read_UART();
			addr = Read_UART();
			addr =  (addr<<8) + val;
		...
		case 6:
			bios_printf(BIOS_PRINTF_COMPORT,  "COMMAND - WR PORT WORD \n");
			bios_printf(BIOS_PRINTF_COMPORT,  "Enter   - ADDRR, DATA  \n");
			//=======1 Read Load ADDRESS =========
			val = Read_UART();
			addr = Read_UART();
			addr =  (addr<<8) + val;
